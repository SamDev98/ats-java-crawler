...
public class DailySync {
    ...
    private final JobMergeService mergeService;  // ✅ Novo service
    ...
    public DailySync(
            ...
            JobRepository repo,
            JobFilters filters,
            JobMergeService mergeService,  // ✅ Injete aqui
        ...
        this.mergeService = mergeService;  // ✅ Adicione
        this.sheets = sheets;
    ...
    public String manualSync() {
        runSync();
        return "✅ Sync completed. Check logs for details.";
    }
    ...
    private void runSync() {
        ...
        log.info("====================================");
        Map<String, List<Job>> results = (Map<String, List<Job>>) registry.runAll();
        List<Job> allJobs = results.values().stream()
                .flatMap(List::stream)
        ...
        log.info("====================================");
        JobMergeService.SyncStats stats = mergeService.mergeWithDatabase(filtered);  // ✅ Agora funciona
        ...
        log.info("====================================");
        int expired = mergeService.expireOldJobs();  // ✅ Agora funciona
        ...
        log.info("====================================");
        discord.send(stats.getNewJobs(), stats.getUpdated(), stats.getReactivated());
